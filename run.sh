...
python combine_video.py "$OUTPUT_DIR/translated_${VIDEO_NAME}.mp4" "$OUTPUT_DIR/lip_synced_face.mp4" "$OUTPUT_DIR/final_${VIDEO_NAME}.mp4" --audio "$OUTPUT_DIR/translated_audio.wav" --face_coordinates "$OUTPUT_DIR/face_coordinates.txt"
